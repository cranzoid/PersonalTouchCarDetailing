...
2. Point ad traffic at `/offers/first-wash`. Claimed codes appear under Admin →
   Offer claims; the licence plate is recorded on the appointment when the car
   arrives, which is what enforces one promotional wash per vehicle.
