...
const MESSAGE_TEMPLATES = [
  ...
  { key: "booking_confirmation_sms", channel: "sms", subject: null, body: "{{businessName}}: your appointment on {{date}} at {{time}} is confirmed. Service: {{services}}. Vehicle: {{vehicle}}. Reply to reschedule." },
