/** Shared class strings for the marketing screens, matching the redesigned admin pages. */
export const card =
  "rounded-2xl border border-[#DCE4EC] bg-white p-5 shadow-[0_8px_24px_rgba(11,42,74,0.04)] sm:p-6";
export const label = "block text-xs font-semibold text-[#526A80]";
export const input =
  "mt-1.5 min-h-11 w-full rounded-xl border border-[#D5DEE7] bg-white px-3 text-sm text-[#1C2026] outline-none placeholder:text-[#9AA8B6] focus-visible:border-[#0B2A4A] focus-visible:ring-2 focus-visible:ring-[#E0A93B]";
