...
/**
 * Campaigns built from a pasted list — fleet prospects met at their shop, a
 * conference sheet, anything that is not already a record in the system.
 *
 * Win-back outreach moved to /admin/marketing, where the people are already
 * known and the whole send is one screen. This kept the campaign builder
 * because a pasted list genuinely needs the extra steps: the contacts have to
 * be parsed and matched, and the consent basis has to be recorded by hand
    ...
    <div className="max-w-[88rem]">
      <header className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <h1 className="mt-1 text-2xl font-bold text-[#0B2A4A]">Pasted lists &amp; fleet campaigns</h1>
          <p className={`mt-1 max-w-3xl ${subtle}`}>
            For contacts who are not in the system yet — fleet prospects you met, a sheet from an
            event. Paste them in, record how you got their details, and send in small batches you can
            check as you go. To message people whose booking fell through, use{" "}
            <Link href="/admin/marketing" className="font-semibold text-[#8A681F] hover:underline">
              Outreach
            </Link>{" "}
            instead.
          </p>
